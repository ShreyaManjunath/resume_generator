          ...
          <div class="col-xl-6 col-sm-6 mb-6">
            <div class="card text-white bg-primary o-hidden h-200">
              <div class="card-body">
                ...
                <div class="mr-5">START MAKING RESUME</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="deskboard.php">
                <span class="float-left">Click here <header></header></span>
